...
const NAV_ITEMS = [
  ...
  { href: "/verification", label: "Verification", icon: VerifyIcon },
  { href: "/results", label: "Results", icon: BarChart3 },
  { href: "/users", label: "Users", icon: Users },
  { href: "/audit-logs", label: "Audit Logs", icon: ScrollText },
  { href: "/ai-governance", label: "AI Governance", icon: Sparkles },
];

// AdminSidebar component that renders the sidebar for administrators.
      ...
      <div className="border-t border-white/10 px-4 py-4">
        ...
        <div className="flex items-center gap-2 px-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-white/50">{member?.role ?? "Not signed in"}</p>
          </div>
        </div>
      </div>
    </aside>
